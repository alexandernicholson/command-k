...
# Bind the key
# Use launcher script - run without -b to avoid return message
tmux bind-key "$KEY" run-shell "COMMAND_K_WIDTH='$POPUP_WIDTH' COMMAND_K_HEIGHT='$POPUP_HEIGHT' '$CURRENT_DIR/scripts/launcher.sh'"
