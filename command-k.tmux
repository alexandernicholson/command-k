...
# Use display-popup directly without run-shell wrapper
tmux bind-key "$KEY" display-popup -E -w "$POPUP_WIDTH" -h "$POPUP_HEIGHT" -e "COMMAND_K_SOURCE_PANE=#{pane_id}" "$CURRENT_DIR/scripts/popup-wrapper.sh"
